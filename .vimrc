...
" set fzf default to ripgrep (must install rigrep)
let $FZF_DEFAULT_COMMAND = 'rg --files --hidden --follow --no-ignore-vcs'

" options viewable by using :options
" set options viewable by using :set all
" or help for individual configs can be accesed :help <name>
set nocompatible
set redrawtime=1000
set background=dark
set laststatus=2
...
let g:prettier#config#printg_width = 100 " default is 'auto'
